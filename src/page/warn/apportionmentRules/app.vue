    ...
    <div v-loading="rulesLoading" class="search-manage">
        <div class="bread-crumb">
            ...
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item >分摊规则告警</el-breadcrumb-item>
            </el-breadcrumb>
            
        </div>
        <div class="main">
            <div class="search">
                <div class="title">分摊规则异常告警</div>
                <div class="content">
                    <el-row>
...
import { RULES,GET_RULES_INFO,GET_RULES_TABLE } from './vuex.js';
...
export default {
    ...
    methods: {
        getApportionmentRulesTableData() {
            ...
            this.$store.dispatch(`${RULES}/${GET_RULES_TABLE}`,sendData);
        },
        getApportionmentRulesData() {
            ...
            sendData.startTime = this.time[0];
            sendData.endTime = this.time[1];
            this.$store.dispatch(`${RULES}/${GET_RULES_INFO}`,sendData);
        },
        searchData() {
            this.getApportionmentRulesData();
            this.getApportionmentRulesTableData();
