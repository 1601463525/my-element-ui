        ...
        <div class="operate-box">
            <div class="filter-box">
                <div class="select-box">
                    ...
                    <div>
                        <span style="width: 76px;">数据状态:</span>
                        <el-select v-model="searchInfo.nextFlowSeqId" placeholder="请选择数据状态" clearable >
                            <el-option v-for="item in nextFlowSeqIdOptions" :key="item.value" :label="item.label" :value="item.value">
                            </el-option>
                        </el-select>
                    </div>
                    <div v-if="searchInfo.taskName === '电表信息维护' || searchInfo.taskName === '金额结算投票'">
...
export default {
    ...
    methods: {
        ...
        reset() {
            ...
            this.searchInfo.taskName = '金额结算投票';
            this.searchInfo.nextFlowSeqId = '';
            this.searchInfo.payType = '';
            this.searchInfo.towerCode = '';
            this.searchData();
        },
    }
};
